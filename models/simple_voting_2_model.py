...
class SimpleVoting2Model(ModelGenerator):
    ...
    def _generate_initial_states(self):
        first_state = {'vote': ArrayTools.create_value_array_of_size(self._no_voters, -1),
                       'voter_action': ArrayTools.create_value_array_of_size(self._no_voters, ''),
                       'pun': ArrayTools.create_value_array_of_size(self._no_voters, None),
                       'finish': ArrayTools.create_value_array_of_size(self._no_voters, False),
                       'ea_action': ''}
    ...
    def _generate_model(self):
        ...
        for state in self.states:
            ...
            for possibility in itertools.product(*actions_product_array):
                ...
                actions = ArrayTools.create_value_array_of_size(self._no_voters + 2, 'Wait')
