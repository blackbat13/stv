...
% for vi in range(1, N_CVoters + 1):
    % for ci in range(1, N_Candidates + 1):
        ...
        shared idle1_VoterC${vi}: coerce -> coerce
    % endfor
% endfor
...
% for vi in range(1, N_CVoters + 1):
    ...
    shared idle2_VoterC${vi}: trackers_sent -> trackers_sent
% endfor
...
% for vi in range(1, N_CVoters + 1):
    ...
    shared idle3_VoterC${vi}: interact -> interact
% endfor
