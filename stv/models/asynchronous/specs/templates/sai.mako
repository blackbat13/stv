...
%for index, agent_id in enumerate(agents_ids):
    ...
    %if agent_id % 2 == 0:
        %% send right
        shared share_${agent_id}_with_${agent_right_id}: sharing -> sharing2 [AI${agent_right_id}_model_quality=%AI${agent_id}_model_quality]
        %% receive left
    ...
    %else:
        ...
        %% send right
        shared share_${agent_id}_with_${agent_right_id}: sharing2 -> sharing3 [AI${agent_right_id}_model_quality=%AI${agent_id}_model_quality]
    %endif
