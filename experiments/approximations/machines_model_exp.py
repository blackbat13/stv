from models.machine_model import MachineModel, MachineModelWithCharging, MachineModelWithStorage
import time
import datetime
from enum import Enum


class MachineModelExp:
    ...
    def run_experiments(self):
        ...
        if self.formula_no == 1:
            print(f'Formula: <<R>>F produce_{self.items_to_produce}')
        elif self.formula_no == 2:
            print(f'Formula: <<R>>F (!stuck && produce_{self.items_to_produce})')
        elif self.formula_no == 3:
            print(f'Not implemented')
        elif self.formula_no == 4:
            print(f'Formula: <<R>>F (energy>0 && produce_{self.items_to_produce})')
